...
CREATE TABLE IF NOT EXISTS "Priorita" ("id" INTEGER PRIMARY KEY, "priorita" TEXT);
...
CREATE TABLE IF NOT EXISTS "Fase" ("id" INTEGER, "descrizione" TEXT NOT NULL);
DROP TABLE IF EXISTS "Bene";
CREATE TABLE IF NOT EXISTS "Bene" ("id" INTEGER, "descrizione" TEXT);
DROP TABLE IF EXISTS "TipoProgetto";
CREATE TABLE IF NOT EXISTS "TipoProgetto" ("id" INTEGER, "tipo", "abbreviazione" TEXT);
DROP VIEW IF EXISTS "vProgetto";
CREATE VIEW "vProgetto" AS
SELECT prj.id,
	codice,
	denominazione,
	priorita,
	i.cognome AS responsabile,
	considerazioni,
	tp.abbreviazione AS tipo,
	website
FROM Progetto prj
	LEFT OUTER JOIN Priorita pri ON prj.prioritaId = pri.id
	LEFT OUTER JOIN Insegnante i ON prj.responsabileId = i.id
	LEFT OUTER JOIN TipoProgetto tp ON prj.tipoProgettoId = tp.id;
DROP VIEW IF EXISTS "vProgettoPerPriorita";
CREATE VIEW "vProgettoPerPriorita" AS
SELECT prj.id,
	codice,
	denominazione,
	priorita,
...
VALUES (
	...
	(
		...
		'https://book.simply-logical.space/src/text/0_preface/_preface.html'
	);
...
VALUES (
	...
	(
		...
		4,
		'https://bvanderlei.github.io/jupyter-guide-to-linear-algebra/Linear_Systems.html'
	),
	(
		17,
		'MiniZinc',
	...
	(
		23,
		'SICPy',
		'Formazione interna sulla didattica della struttura e della interpretazione dei programmi',
		2,
		1,
		'Stima ore frontali: 16 ore.
		E''importante uniformare la presentazione dei linguaggi di programmazione affinché tutti gli studenti sappiano usare un linguaggio di programmazione
		per rappresentare le idee sui processi di calcolo.
		Il corso si propone di illustrare la didattica della programmazione nello spirito di SICP,
		usando il linguaggio Python (https://www.composingprograms.com/) e gli strumenti PythonTutor (https://pythontutor.com/) e Jupyter ',
		5,
		NULL
	),
	(
	...
	(
		...
		5,
		1,
		'Stima ore frontali: 30 divise in 6 ore di elicitazione e analisi requisiti;
...
4 ore di validazione e correzione dei bug.',
	...
	(
		33,
		'RegistroWebApp',
		'Un registro elettronico per gestire la valutazione',
		5,
		1,
	...
	(
		34,
		'MathLinProg',
		'Laboratorio di Programmazione Lineare',
		5,
		1,
	...
	(
		35,
		'SimplyLogical',
		'Laboratorio di Programmazione Logica e Reasoning in Prolog',
		6,
		1,
		'Destinatari i ragazzi del quinto anno Scienze Applicate',
		4,
	...
	(
		36,
		'CodeQA',
		'Laboratorio sulla qualità del codice',
		6,
		1,
		'Studenti del quinto anno SIA',
		4,
	...
	(
		37,
		'DigitalImages',
		'Laboratorio di elaborazione delle immagini digitali',
		6,
		1,
		'Studenti del triennio scientifico',
		4,
		'https://vincmazet.github.io/bip/index.html'
	);
;
INSERT INTO "TipoProgetto" ("id", "tipo", "abbreviazione")
VALUES (1, 'Certificazione', 'Cert'),
	(
		2,
	...
	(
		5,
		'Dipartimentale - Formazione interna',
		'Dip - Form Interna'
	),
	(
		6,
